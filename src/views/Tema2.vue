...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Se manejan diferentes niveles de formalidad y contacto entre las partes; las comunicaciones en una negociación son fundamentales en la construcción de relaciones, manejo al instante de la documentación y el planeamiento de diferentes alternativas para sus planteamientos.
    ...
    .d-flex.flex-wrap.mb-5
      .col-lg-6.col-xl-7.pe-lg-4
        p En la actualidad, la mayoría de los envíos internacionales necesitan utilizar más de un tipo de transporte desde su punto de origen hasta el destino final. Cada uno de los tipos de transporte global ha jugado un papel esencial para facilitar la diversificación geográfica. 
        .cajon.color-secundario.p-4.mb-5(style="background-color: #E9F0FE" data-aos="fade-left")
    ...
    p.mb-4.text-center.fw-bold A continuación, se presentan los pasos para el proceso de contratación de transporte:
