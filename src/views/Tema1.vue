...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.fw-bold.text-center En el siguiente recurso de aprendizaje se relacionan los pasos recomendados para una exportación:
    ...
    .container-100.pb-5.mb-5(style="background: linear-gradient(180deg, rgba(255,255,255,1) 9%, rgba(243,246,254,1) 9%, rgba(243,246,254,1) 100%);")
      ...
      PasosA.color-acento-botones.col-xl-10.mx-auto(tipo="n")
        .row
    ...
    p Cuando se trate de importaciones cuyos montos sean superiores a mil dólares americanos (USD1.000), se debe contratar los servicios de una agencia de aduanas para que realice este proceso.

    p.mb-5 Para el levante o retiro de la mercancía, una vez cancelados los tributos aduaneros, debe dirigirse al Depósito Habilitado de Aduanas donde se encuentre la mercancía y presentar los siguientes documentos, los cuales deberán conservarse por un funcionario de la aduana respectiva por un término de cinco años mínimo:

    p.mb-5.text-center.fw-bold Los documentos de soporte para presentar la declaración de importación son:
    ...
    .d-flex.flex-wrap.mb-5
      .col-lg-6.col-xl-7.pe-lg-4
        p El arancel es una herramienta utilizada internacionalmente y está compuesta por dos partes: nomenclatura y gravamen.
        p Es usada para codificar mercancías de importación y exportación para inspección en los procedimientos aduaneros. 
        p Permite determinar un código de 6 dígitos de un producto a nivel internacional y con este se identifica la mercancía en el mercado internacional, mostrando su comportamiento en cuanto a:
        ul.lista-ul--separador
          li(style="border-bottom-style: dashed;")
            i.fas.fa-angle-right(style="font-size: 24px; color: #FE7062")
            | Arancel aduanero.
    ...
    p.fw-bold.text-center.mb-0 A continuación, se presenta la finalidad de contratar un agente de carga: 
    ...
    p.mb-5 Dentro de las funciones de un agente de aduana se encuentra que controlan las mercancías que entran y salen del país, quien autoriza o rechaza el movimiento de productos y lleva estadísticas de importaciones y exportaciones de los países.  

    p.fw-bold.text-center.mb-5 Conozca la relación de usuarios autorizados por el Operador económico autorizado OEA, que se muestra en la siguiente tabla:
    ...
    p.mb-5 Es importante que reconozca los trámites que realiza un agente de aduana:
    ...
    p.text-center.fw-bold.mb-5 Existen 3 tipos de zona franca, descúbralos en cada tarjeta que se presenta a continuación: 
    ...
    .d-flex.flex-wrap.container-100.py-5(style="background-color: #E6FAF9")
      ul.lista-ul.mb-5.border-ul-1.col-lg-6.pe-lg-4
        li
          ...
          | <b>Ley marco:</b> Ley 48 de 1983.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Ley 109 de 1985</b> - Por la cual se establece el estatuto de las zonas francas establecimientos públicos.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Artículo 6 Ley 7 de 1991</b> - Ley marco.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Ley 300 de 1996</b> - Ley general de turismo, zonas francas turísticas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 1471 de 1986</b> - reglamenta Ley 109 de 1985.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 2131 de 1991</b> - sobre estructura y funcionamiento de las zonas francas industriales de bienes y de servicios (zonas francas turísticas).
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 2111 de 1992</b> - liquidación de establecimientos públicos operadores de zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 971 de 1993</b> - modificación parcial al régimen de zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 1125 de 1993</b> - procedimiento de liquidación de los establecimientos públicos operadores de zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 1590 de 1993</b> - modificación al Decreto 2131/91.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 2624 de 1993</b> - enajenación de mercancías por establecimientos públicos operadores de zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 2480 de 1993</b> - régimen de zonas francas en liquidación.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 1131 de 1994</b> - proceso de liquidación de los establecimientos públicos operadores de zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 1258 de 1994</b> - ampliación y reducción de zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 1321 de 1994</b> - medidas especiales para zonas francas en liquidación.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 354 de 1995</b> - se aclaran los artículos 54 del Decreto 2131 de 1991 y 28 del Decreto 971 de 1993.

      ul.lista-ul.mb-5.col-lg-6.ps-lg-4
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 2233 de 1996</b> - régimen de zonas francas industriales de bienes y de servicios.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Resolución Incomex 273 de 1997</b> - Plan Vallejo - zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 727 de 1997</b> - modifica el Decreto 2233 de 1996 en el tema de certificación.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Resolución Mincomex 148 de 1997</b> - registro de usuarios de las zonas francas industriales de bienes y de servicios.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Resolución Mincomex 693 de 1998</b> - formulario movimiento de mercancías.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 2553 de 1999</b> - estructura ministerio - competencias sobre zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 2681 de 1999</b> - registro usuarios de zona franca.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Decreto 918 de 22 de mayo de 2001</b>- se modifica parcialmente el régimen de zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Artículo 392 al 410 Decreto 2685 de 1999</b> - Operaciones aduaneras en zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Artículos 333 al 336 y 367 al 390 Resolución 4240 de 2000 de la DIAN</b> - operaciones aduaneras en zonas francas.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Artículos 53 y 54 de la resolución externa No. 8 de 2000</b> de la Junta Directiva del Banco de la República.
        li
          i.lista-ul__vineta(style="color: #57DBD8")
          | <b>Artículo 10 Circular reglamentaria externa DCIN 31 de 2000</b> del Banco de la República (modificada por la circular reglamentaria externa DCIN 4 de 2001) - operaciones de cambio en zonas francas.
